...
public class AuthorizationServerSecurityConfiguration {
    ...
    public SecurityFilterChain appSecurity(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        auth -> auth
                                .requestMatchers("/login", "/clients/register", "/roles/save", "/users/register")
                                .permitAll()
                                .anyRequest()
                                .authenticated()
                )
        ...
        http.csrf(csrf -> csrf.ignoringRequestMatchers("/clients/register", "/roles/save", "/users/register"));
        return http.build();
    }
